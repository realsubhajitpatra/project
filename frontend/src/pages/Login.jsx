...
const Login = () => {
  ...
  return( <section className='w-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10' >
    ...
    <form className='py-4 md:py-0'>
      ...
      <p className='mt-5 text-textColor text-center'>Don&apos;t have an account ? <Link to={'/register'}>Register</Link></p>
    </form>
  </section>
  )
}
