   ...
   return <div className='py-[30px] px-3 lg:px-5' >
    ...
    <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>{desc}</p>
      ...
      <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
                ...
                <span className='w-[44px] h-[44px] flex items-center justify-center text-[18px] leading-[30px] font-[600]' style={{background:`${bgColor}`,color:`${bgColor}`,borderRadius:"6px 0 0 6px"}}>
                    {index+1}
                </span>
      </div>
